...
def extract_weighted_keyphrases_batched(
 ...
 logger.warning(f"⚠ [AI-BATCHED] Batch {batch_num} failed: {e}, continuing...")
 continue
 
 if not all_batch_themes:
 logger.warning("⚠ [AI-BATCHED] No themes extracted from batches")
 return []
...
Return ONLY valid JSON, no other text."""
 ...
 logger.warning("⚠ [AI-BATCHED] Failed to parse refinement response, using aggregated themes")
