...
1⃣ **Low score** = Less of that trait (e.g., low extraversion means more introverted). 
6⃣ **High score** = More of that trait (e.g., high openness means very curious & creative). 
