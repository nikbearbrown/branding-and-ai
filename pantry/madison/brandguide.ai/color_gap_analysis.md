...
| **Accessibility (WCAG)** | ⚠ **Partial** | We extract text color rules (e.g. "Use White text") but do not yet mathematically enforce contrast checks. | Extraction is done; logic implementation is the next step. |
