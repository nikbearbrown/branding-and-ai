...
Where the model genuinely helps: pressure-testing a draft PRD by asking it what specific questions an engineer would ask that the PRD does not answer. Models are good at surfacing the missing detail because they have read many PRDs and the gaps follow patterns.
